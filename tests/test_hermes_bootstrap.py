...
def _fresh_import():
    ...
    import dobby_bootstrap  # noqa: WPS433
...
class TestEntryPointsImportBootstrap:
    """Every Hermes entry point must import dobby_bootstrap as its
    ...
    # import dobby_bootstrap before doing any file I/O or stdout writes.
    ENTRY_POINTS = [
    ...
    def test_entry_point_imports_bootstrap(self, path):
        """The file must contain 'import dobby_bootstrap' and that
        ...
        assert first_import_name == "hermes_bootstrap", (
            ...
            f"'import dobby_bootstrap' line to be the first import."
        )
