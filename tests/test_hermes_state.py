...
import dobby_state
from dobby_state import SCHEMA_SQL, SCHEMA_VERSION, SessionDB
...
class TestFTS5Search:
    ...
    def test_sanitize_fts5_query_runtime_is_bounded(self):
        ...
        from dobby_state import MAX_FTS5_QUERY_CHARS, SessionDB
...
class TestSchemaInit:
    ...
    def test_schema_version(self, db):
        from dobby_state import SCHEMA_VERSION
    ...
    def test_schema_sql_is_source_of_truth(self, db):
        ...
        """
        from dobby_state import SCHEMA_SQL
...
class TestConcurrentWriteSafety:
    ...
    def test_sqlite_timeout_is_at_least_30s(self, db):
        ...
        import inspect
        from dobby_state import SessionDB as _SessionDB
