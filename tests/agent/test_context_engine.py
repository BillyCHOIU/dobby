...
class TestPluginContextEngineSlot:
    ...
    def test_register_engine(self):
        from dobby_cli.plugins import PluginManager, PluginContext, PluginManifest
        mgr = PluginManager()
    ...
    def test_get_plugin_context_engine(self):
        from dobby_cli.plugins import PluginManager, get_plugin_context_engine
...
class TestInitAgentDoesNotMutatePluginSingleton:
    ...
    def test_child_init_does_not_corrupt_parent_singleton(self, monkeypatch):
        import dobby_cli.plugins as plugins_mod
        from dobby_cli.plugins import PluginManager
