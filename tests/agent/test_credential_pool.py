...
def test_write_credential_pool_sanitizes_borrowed_payload_at_disk_boundary(tmp_path, monkeypatch):
    ...
    from dobby_cli.auth import write_credential_pool
...
def test_is_terminal_xai_oauth_refresh_error():
    from dobby_cli.auth import AuthError, _is_terminal_xai_oauth_refresh_error
...
def test_is_terminal_codex_oauth_refresh_error():
    from dobby_cli.auth import AuthError, _is_terminal_codex_oauth_refresh_error
...
def test_persist_preserves_concurrent_disk_only_entry(tmp_path, monkeypatch):
    ...
    from agent.credential_pool import load_pool
    from dobby_cli.auth import read_credential_pool, write_credential_pool
