...
import dobby_cli.models as _models_mod
...
class TestOpenRouterToolSupportHelper:
    ...
    def test_tools_in_supported_parameters(self):
        from dobby_cli.models import _openrouter_model_supports_tools
...
class TestFindOpenrouterSlug:
    def test_exact_match(self):
        from dobby_cli.models import _find_openrouter_slug
        with patch("hermes_cli.models.fetch_openrouter_models", return_value=LIVE_OPENROUTER_MODELS):
...
class TestNousRecommendedModels:
    ...
    def test_fetch_caches_per_portal_url(self):
        from dobby_cli.models import fetch_nous_recommended_models
...
class TestCodexSoftAcceptPlausibilityGate:
    ...
    def test_unrelated_name_rejected_on_openai_codex(self):
        from dobby_cli.models import validate_requested_model
