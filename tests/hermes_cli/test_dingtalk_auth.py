...
class TestApiPost:
    ...
    def test_raises_on_network_error(self):
        import requests
        from dobby_cli.dingtalk_auth import _api_post, RegistrationError
    ...
    def test_returns_data_on_success(self):
        from dobby_cli.dingtalk_auth import _api_post
...
class TestBeginRegistration:
    ...
    def test_chains_init_then_begin(self):
        from dobby_cli.dingtalk_auth import begin_registration
    ...
    def test_missing_nonce_raises(self):
        from dobby_cli.dingtalk_auth import begin_registration, RegistrationError
...
class TestWaitForSuccess:
    ...
    def test_returns_credentials_on_success(self):
        from dobby_cli.dingtalk_auth import wait_for_registration_success
    ...
    def test_success_without_credentials_raises(self):
        from dobby_cli.dingtalk_auth import wait_for_registration_success, RegistrationError
...
class TestRenderQR:
    ...
    def test_returns_false_when_qrcode_missing(self, monkeypatch):
        from dobby_cli import dingtalk_auth
    ...
    def test_prints_when_qrcode_available(self, capsys):
        ...
        from dobby_cli.dingtalk_auth import render_qr_to_terminal
...
class TestConfigOverrides:
    ...
    def test_base_url_default(self, monkeypatch):
        ...
        import importlib
        import dobby_cli.dingtalk_auth as mod
