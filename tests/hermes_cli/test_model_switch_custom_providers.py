...
import dobby_cli.providers as providers_mod
from dobby_cli.model_switch import list_authenticated_providers, switch_model
...
def test_resolve_custom_provider_passes_key_env():
    ...
    """
    from dobby_cli.providers import resolve_custom_provider
