...
from dobby_cli.nous_account import NousPortalAccountInfo, NousToolAccessInfo
from dobby_cli import nous_subscription as ns
...
def _capture_checklist(monkeypatch, *, selected_idx):
    ...
    import dobby_cli.setup as setup_mod
