...
def test_load_env_caches_on_repeat_calls():
    ...
    from dobby_cli.config import invalidate_env_cache, load_env
...
def test_save_env_value_invalidates_cache(tmp_path, monkeypatch):
    ...
    from dobby_cli import config as config_mod
    from dobby_cli.config import invalidate_env_cache, load_env, save_env_value
