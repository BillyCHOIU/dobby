...
import dobby_cli.doctor as doctor
import dobby_cli.gateway as gateway_cli
from dobby_cli import doctor as doctor_mod
from dobby_cli.doctor import _has_provider_env_config
...
def test_has_healthy_oauth_fallback_returns_false_for_unknown_provider():
    from dobby_cli.doctor import _has_healthy_oauth_fallback_for_apikey_provider
