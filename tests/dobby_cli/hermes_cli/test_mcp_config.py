...
class TestMcpList:
    def test_list_empty_config(self, tmp_path, capsys):
        from dobby_cli.mcp_config import cmd_mcp_list
...
class TestMcpRemove:
    def test_remove_existing_server(self, tmp_path, capsys, monkeypatch):
        ...
        from dobby_cli.mcp_config import cmd_mcp_remove
...
class TestMcpAdd:
    def test_add_no_transport(self, capsys):
        ...
        from dobby_cli.mcp_config import cmd_mcp_add
...
class TestMcpTest:
    def test_test_not_found(self, tmp_path, capsys):
        _seed_config(tmp_path, {})
        from dobby_cli.mcp_config import cmd_mcp_test
...
class TestProbeEnvResolution:
    ...
    def test_resolve_interpolates_header(self, monkeypatch):
        from dobby_cli.mcp_config import _resolve_mcp_server_config
    ...
    def test_probe_resolves_before_connect(self, monkeypatch):
        ...
        import dobby_cli.mcp_config as mc
...
class TestStripBearerPrefix:
    ...
    def test_bare_token_unchanged(self):
        from dobby_cli.mcp_config import _strip_bearer_prefix
...
class TestConfigHelpers:
    def test_save_and_load_mcp_server(self, tmp_path):
        from dobby_cli.mcp_config import _save_mcp_server, _get_mcp_servers
    ...
    def test_env_key_for_server(self):
        from dobby_cli.mcp_config import _env_key_for_server
...
class TestMcpLogin:
    def test_login_rejects_unknown_server(self, tmp_path, capsys):
        _seed_config(tmp_path, {})
        from dobby_cli.mcp_config import cmd_mcp_login
...
class TestMcpReauth:
    def test_reauth_all_visits_only_oauth_servers_in_order(
        ...
        from dobby_cli.mcp_config import cmd_mcp_reauth
