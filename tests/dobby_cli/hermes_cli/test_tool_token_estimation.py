...
def test_estimate_tool_tokens_returns_positive_counts():
    ...
    from dobby_cli.tools_config import _estimate_tool_tokens
...
def test_status_fn_returns_formatted_token_count(monkeypatch):
    ...
    import dobby_cli.tools_config as tc
    from dobby_cli.tools_config import CONFIGURABLE_TOOLSETS
...
def test_curses_checklist_numbered_fallback_shows_status(monkeypatch, capsys):
    ...
    from dobby_cli.curses_ui import _numbered_fallback
