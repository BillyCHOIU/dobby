...
from dobby_cli.proxy.adapters import ADAPTERS, get_adapter
from dobby_cli.proxy.adapters.base import UpstreamAdapter, UpstreamCredential
from dobby_cli.proxy.adapters.nous_portal import NousPortalAdapter
from dobby_cli.proxy.adapters.xai import XAIGrokAdapter
...
from dobby_cli.proxy.server import create_app  # noqa: E402
...
def test_cmd_proxy_status_runs(capsys, tmp_path, monkeypatch):
    monkeypatch.setenv("HERMES_HOME", str(tmp_path))
    from dobby_cli.proxy.cli import cmd_proxy_status
...
def test_cmd_proxy_providers_runs(capsys):
    from dobby_cli.proxy.cli import cmd_proxy_list_providers
...
def test_cmd_proxy_start_refuses_unknown_provider(capsys):
    from dobby_cli.proxy.cli import cmd_proxy_start
