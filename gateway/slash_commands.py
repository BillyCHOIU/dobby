...
from dobby_cli.config import cfg_get, clear_model_endpoint_credentials
from utils import (
    atomic_json_write,
    atomic_yaml_write,
...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_help_command(self, event: MessageEvent) -> str:
        ...
        from dobby_cli.commands import gateway_help_lines
        lines = [
            ...
            if has_picker:
                ...
                if providers:
                    ...
                    async def _on_model_selected(
                        ...
                        try:
                            from dobby_cli.context_switch_guard import (
    ...
    async def _handle_sessions_command(self, event: MessageEvent) -> str:
        ...
        from dobby_cli.session_listing import (
