...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _run_post_connect_housekeeping(self) -> None:
        ...
        try:
            ...
            try:
                ...
                from dobby_cli.commands import telegram_menu_commands, telegram_menu_max_commands
                if not self._bot:
                    return
    ...
    def _build_provider_keyboard(self, providers: list):
        ...
        """
        try:
            from dobby_cli.models import group_providers
        except Exception:
    ...
    async def _handle_model_picker_callback(
        ...
        if data.startswith("mp:"):
            ...
            group_id = data[4:]
            try:
                from dobby_cli.models import PROVIDER_GROUPS
...
def interactive_setup() -> None:
    ...
    """
    from dobby_cli import setup as _setup_mod
