...
def compress_context(
    ...
    *,
    ...
    # long-lived ``dobby_state.SessionDB`` class still bound to the
        ...
        if agent._session_db:
            try:
                ...
                if in_place:
                    ...
                    # from ``dobby_logging._session_context`` (set once per turn in
                    ...
                    try:
                        from dobby_cli.goals import migrate_goal_to_session
