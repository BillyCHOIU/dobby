...
from dobby_cli.default_soul import DEFAULT_SOUL_MD, is_legacy_template_soul
...
# Re-export from dobby_constants — canonical definition lives there.
from dobby_constants import get_hermes_home  # noqa: F811,E402
...
def migrate_config(interactive: bool = True, quiet: bool = False) -> Dict[str, Any]:
    ...
    if isinstance(raw_mcp_servers, dict):
        try:
            from dobby_cli.mcp_security import validate_mcp_server_entry as _validate_mcp_server_entry
        except Exception:
    ...
    try:
        ...
        from dobby_cli.toolset_validation import validate_platform_toolsets
