...
from dobby_constants import display_hermes_home, is_termux as _is_termux_environment
...
class CLICommandsMixin:
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        ...
        from cli import _cprint
        from dobby_cli.journey import register_cli
    ...
    def _handle_paste_command(self):
        ...
        from dobby_cli.clipboard import has_clipboard_image
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from dobby_cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from dobby_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        try:
            from dobby_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_kanban_command(self, cmd: str):
        ...
        """
        from dobby_cli.kanban import run_slash
    ...
    def _handle_skills_command(self, cmd: str):
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            from dobby_cli.write_approval_commands import handle_pending_subcommand
            ...
            if out is not None:
                print(out)
                return
        from dobby_cli.skills_hub import handle_skills_slash
    ...
    def _handle_goal_command(self, cmd: str) -> None:
        ...
        from dobby_cli.goals import parse_contract
    ...
    def _handle_goal_draft(self, objective: str) -> None:
        ...
        from cli import _DIM, _RST, _cprint
        from dobby_cli.goals import draft_contract
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from dobby_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from dobby_cli.models import _is_anthropic_fast_model
    ...
    def _handle_debug_command(self, cmd_original: str = ""):
        ...
        """
        from dobby_cli.debug import run_debug_share
    ...
    def _handle_update_command(self) -> bool:
        ...
        when cancelled.
        """
        from dobby_cli.config import is_managed, format_managed_message
