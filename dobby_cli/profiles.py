...
def create_profile(
    ...
    if not soul_path.exists():
        try:
            from dobby_cli.default_soul import DEFAULT_SOUL_MD
...
def _maybe_register_gateway_service(profile_name: str) -> None:
    ...
    try:
        ...
        from dobby_cli.service_manager import get_service_manager
...
def _cleanup_gateway_service(name: str, profile_dir: Path) -> None:
    ...
    try:
        ...
        from dobby_cli.gateway import get_service_name, get_launchd_plist_path
