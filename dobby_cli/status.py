...
from dobby_cli.auth import AuthError, resolve_provider
from dobby_cli.colors import Colors, color
from dobby_cli.config import get_env_path, get_env_value, get_hermes_home, load_config
...
from dobby_cli.runtime_provider import resolve_requested_provider
...
def show_status(args):
    ...
    if _effective_provider_label() == "LM Studio":
        from dobby_cli.models import probe_lmstudio_models
        model_cfg = config.get("model")
    ...
    try:
        from dobby_cli.gateway import get_gateway_runtime_snapshot, _format_gateway_pids
