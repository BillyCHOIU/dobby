...
from dobby_cli import __version__ as _HERMES_VERSION
...
def _codex_curated_models() -> list[str]:
    ...
    """
    from dobby_cli.codex_models import DEFAULT_CODEX_MODELS, _add_forward_compat_models
...
def fetch_openrouter_models(
    ...
    *,
    ...
    try:
        from dobby_cli.model_catalog import get_curated_openrouter_models
...
def get_curated_nous_model_ids() -> list[str]:
    ...
    """
    try:
        from dobby_cli.model_catalog import get_curated_nous_models
...
def list_available_providers() -> list[dict[str, str]]:
    ...
    for pid in provider_order:
        ...
        has_creds = False
        try:
            from dobby_cli.auth import get_auth_status, has_usable_secret
            if pid == "custom":
...
def _resolve_static_model_alias(
    ...
    try:
        from dobby_cli.model_switch import MODEL_ALIASES
    except Exception:
        return None
...
def _resolve_copilot_catalog_api_key() -> str:
    ...
    """
    try:
        from dobby_cli.auth import resolve_api_key_provider_credentials
    ...
    try:
        ...
        from dobby_cli.copilot_auth import (
...
def provider_model_ids(provider: Optional[str], *, force_refresh: bool = False) -> list[str]:
    ...
    if normalized == "nous":
        ...
        try:
            from dobby_cli.auth import fetch_nous_models, resolve_nous_runtime_credentials
            creds = resolve_nous_runtime_credentials()
            if creds:
