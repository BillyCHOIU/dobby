...
from dobby_cli.dashboard_auth import (
    get_provider,
    list_providers,
    list_session_providers,
)
from dobby_cli.dashboard_auth.audit import AuditEvent, audit_log
from dobby_cli.dashboard_auth.base import (
    InvalidCodeError,
...
def _redirect_uri(request: Request) -> str:
    ...
    from dobby_cli.dashboard_auth.prefix import (
        prefix_from_request,
        resolve_public_url,
    )
...
async def api_auth_ws_ticket(request: Request):
    ...
    from dobby_cli.dashboard_auth.ws_tickets import TTL_SECONDS, mint_ticket
