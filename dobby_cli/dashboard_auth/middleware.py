...
from dobby_cli.dashboard_auth import list_session_providers
from dobby_cli.dashboard_auth.audit import AuditEvent, audit_log
from dobby_cli.dashboard_auth.base import ProviderError, RefreshExpiredError
from dobby_cli.dashboard_auth.cookies import (
    clear_sso_attempt_cookie,
    read_session_cookies,
    read_sso_attempt_cookie,
    set_sso_attempt_cookie,
)
from dobby_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
...
def _unauth_response(request: Request, *, reason: str) -> Response:
    ...
    """
    from dobby_cli.dashboard_auth.prefix import prefix_from_request
...
def _auto_sso_response(request: Request) -> Response | None:
    ...
    from dobby_cli.dashboard_auth.cookies import detect_https
    set_sso_attempt_cookie(
...
async def gated_auth_middleware(
    ...
    if session is None:
        ...
        from dobby_cli.dashboard_auth.cookies import clear_session_cookies
        from dobby_cli.dashboard_auth.prefix import prefix_from_request
