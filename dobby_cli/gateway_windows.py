...
def _current_profile_cli_args() -> list[str]:
    ...
    from dobby_cli.gateway import _profile_arg
...
def get_task_name() -> str:
    ...
    from dobby_cli.gateway import _profile_suffix
...
def windowless_gateway_restart_spec(
    ...
    from dobby_cli.config import get_hermes_home
    from dobby_cli.gateway import PROJECT_ROOT
...
def _prompt_install_choices(
    ...
    from dobby_cli.setup import prompt_yes_no
...
def _install_startup_fallback(script_path: Path, start_now: bool, detail: str) -> None:
    ...
    from dobby_cli.gateway import find_gateway_pids, _profile_arg
